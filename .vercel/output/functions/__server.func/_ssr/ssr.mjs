...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ckr6s_yc.mjs");
...
var manifest = {
	"9a572a1ab9749581d2d450bd09d960022c9164d569fac15f148dfd71665f5a93": {
		functionName: "translateCues_createServerFn_handler",
		importer: () => import("./ai-BT-JoxQq.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-lDxc3sUC.mjs").then((n) => n.t),
